...
Discover Smart Contracts source [here](https://github.com/lucaskleiner/erc20-token).
...
Code released under the [MIT License](https://github.com/lucaskleiner/erc20-token/blob/master/LICENSE).
